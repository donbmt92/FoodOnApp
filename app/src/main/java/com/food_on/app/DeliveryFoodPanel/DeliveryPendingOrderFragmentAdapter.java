...
import com.food_on.app.ChefFoodPanel.ChefOrderTobePrepared;
import com.food_on.app.ChefFoodPanel.ChefOrdertobePrepareView;
...
public class DeliveryPendingOrderFragmentAdapter extends RecyclerView.Adapter<DeliveryPendingOrderFragmentAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.grandtotalprice.setText("Tổng Cộng: đ " + deliveryShipOrders1.getGrandTotalPrice());
                                                    ...
                                                    public void onSuccess(Void aVoid) {
                                                        FirebaseDatabase.getInstance().getReference().child("Tokens").child(chefid).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                            ...
                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                ...
                                                                builder.setMessage("Thành công. Giờ bạn có thể kiểm tra khi đang giao");
                                                                builder.setCancelable(false);
                                                                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                    @Override
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        Intent b = new Intent(context, Delivery_FoodPanelBottomNavigation.class);
