                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    data.addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                            ...
                                            hashMap1.put("Status", "Đầu bếp đang chuẩn bị đơn hàng...");
                                                                        ...
                                                                        public void onSuccess(Void aVoid) {
                                                                            ...
                                                                            FirebaseDatabase.getInstance().getReference().child("Tokens").child(userid).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                ...
                                                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                    ...
                                                                                    sendNotifications(usertoken, "Estimated Time", "Đầu bếp đang chuẩn bị món của bạn", "Preparing");
                                                                                    progressDialog.dismiss();
                                                                                    AlertDialog.Builder builder = new AlertDialog.Builder(ChefOrdertobePrepareView.this);
                                                                                    builder.setMessage("Đơn hàng sẵn sàng");
