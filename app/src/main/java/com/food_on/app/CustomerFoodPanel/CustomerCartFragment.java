                ...
                if (cartModelList.size() == 0) {
                    ...
                    remove.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setMessage("Bạn có muốn xóa ");
                                                                                                                            ...
                                                                                                                            public void onSuccess(Void aVoid) {
                                                                                                                                ...
                                                                                                                                FirebaseDatabase.getInstance().getReference().child("Tokens").child(ChefId).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                                                    ...
                                                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                                                        ...
                                                                                                                                        sendNotifications(usertoken, "New Order", "Bạn có một đơn đặt hàng", "Order");
                                                                                                                                        progressDialog.dismiss();
                                                                                                                                        ReusableCodeForAll.ShowAlert(getContext(), "", "Đặt hàng thành công, vui lòng đợi bên Đầu Bếp đồng ý <3 ");
                                                                                                                                    }
...
//                                                                }
                                                ...
                                                ReusableCodeForAll.ShowAlert(getContext(), "Error", "Hình như bạn đang có 1 đơn hàng, vui lòng thanh toán để được đặt tiếp");
                                            }
